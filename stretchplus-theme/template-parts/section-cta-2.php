<section id="cta-2" class="reveal">
        <h2>まずは1回、体感してみてください。</h2>
        <p class="final-cta-sub">初回限定価格 60分 3,980円（税込）</p>
        <div style="display: flex; gap: 30px; justify-content: center; flex-wrap: wrap;">
            <!-- Group 1: WEB & Hotpepper -->
            <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                <a href="https://yui.kanzashi.com/l/stretch-plus/kirei" class="btn-web-outline" target="_blank" style="background: rgba(255,255,255,0.1);"><i class="far fa-file-alt"></i> WEBで予約する</a>
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                <a href="https://lin.ee/rboKm7N" class="btn-line-outline" target="_blank" style="background: rgba(255,255,255,0.1);"><i class="fab fa-line"></i> LINEで相談する</a>
