<section id="cta-1" class="bottom-cta-banner reveal">
        ...
        <div style="display: flex; gap: 30px; justify-content: center; flex-wrap: wrap;">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                <a href="https://yui.kanzashi.com/l/stretch-plus/kirei" class="btn btn-web pulse-btn" target="_blank" ><i class="far fa-file-alt"></i> WEBで予約する</a>
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
                <a href="https://lin.ee/rboKm7N" class="btn btn-line pulse-btn" target="_blank" ><i class="fab fa-line"></i> LINEで相談する</a>
